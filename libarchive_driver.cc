...
/****************
function ==> lafe_setprogname
demangle ==> lafe_setprogname
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive_fe/err.c : 55
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @lafe_setprogname(ptr noundef, ptr noundef) #9
*****************/
void lafe_setprogname(void *, void *);

/****************
function ==> archive_match_new
demangle ==> archive_match_new
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_match.c : 217
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @archive_match_new() #9
*****************/
void *archive_match_new();

/****************
function ==> archive_read_new
demangle ==> archive_read_new
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_read.c : 101
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @archive_read_new() #9
*****************/
void *archive_read_new();

/****************
function ==> archive_read_support_filter_all
demangle ==> archive_read_support_filter_all
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_read_support_filter_all.c : 42
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_read_support_filter_all(ptr noundef) #9
*****************/
uint32_t archive_read_support_filter_all(void *);

/****************
function ==> archive_read_support_format_all
demangle ==> archive_read_support_format_all
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_read_support_format_all.c : 33
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_read_support_format_all(ptr noundef) #9
*****************/
uint32_t archive_read_support_format_all(void *);

/****************
function ==> archive_read_open_filename
demangle ==> archive_read_open_filename
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_read_open_filename.c : 103
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_read_open_filename(ptr noundef, ptr noundef, i64 noundef) #9
*****************/
uint32_t archive_read_open_filename(void *, void *, uint64_t);

/****************
function ==> archive_read_next_header
demangle ==> archive_read_next_header
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_virtual.c : 146
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_read_next_header(ptr noundef, ptr noundef) #9
*****************/
uint32_t archive_read_next_header(void *, void *);

/****************
function ==> archive_entry_pathname
demangle ==> archive_entry_pathname
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_entry.c : 554
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @archive_entry_pathname(ptr noundef) #9
*****************/
void *archive_entry_pathname(void *);

/****************
function ==> archive_match_excluded
demangle ==> archive_match_excluded
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_match.c : 268
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_match_excluded(ptr noundef, ptr noundef) #9
*****************/
uint32_t archive_match_excluded(void *, void *);

/****************
function ==> archive_read_extract2
demangle ==> archive_read_extract2
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_read_extract2.c : 82
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_read_extract2(ptr noundef, ptr noundef, ptr noundef) #9
*****************/
uint32_t archive_read_extract2(void *, void *, void *);

/****************
function ==> archive_read_close
demangle ==> archive_read_close
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_virtual.c : 72
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_read_close(ptr noundef) #9
*****************/
uint32_t archive_read_close(void *);

/****************
function ==> archive_read_free
demangle ==> archive_read_free
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_virtual.c : 100
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_read_free(ptr noundef) #9
*****************/
uint32_t archive_read_free(void *);

/****************
function ==> archive_match_path_unmatched_inclusions_next
demangle ==> archive_match_path_unmatched_inclusions_next
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_match.c : 489
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_match_path_unmatched_inclusions_next(ptr noundef, ptr noundef) #9
*****************/
uint32_t archive_match_path_unmatched_inclusions_next(void *, void *);

/****************
function ==> archive_match_path_unmatched_inclusions
demangle ==> archive_match_path_unmatched_inclusions
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_match.c : 477
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_match_path_unmatched_inclusions(ptr noundef) #9
*****************/
uint32_t archive_match_path_unmatched_inclusions(void *);

/****************
function ==> archive_match_free
demangle ==> archive_match_free
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/libarchive-2017-01-04/build/SRC/libarchive/archive_match.c : 240
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @archive_match_free(ptr noundef) #9
*****************/
uint32_t archive_match_free(void *);
...
LOADMEM:
{
    TDD_setLoadPtr(0, 0, 3, 0);
}

{
    TDD_setLoadPtr(1, 0, 4, 0);
}
...
NODEID_0 : {
    ...
    // try { lafe_setprogname(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_1 : {
    if (!TDD_runNode()) goto ROOT;
    void *__TDD_var_0;
    try { __TDD_var_0 = archive_match_new(); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_0, nullptr);
    TDD_setPtr(__TDD_var_0, 5, 0);
    TDD_registerFree(archive_match_free, __TDD_var_0);
    goto ROOT;
}
...
NODEID_2 : {
    if (!TDD_runNode()) goto ROOT;
    void *__TDD_var_0;
    try { __TDD_var_0 = archive_read_new(); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_0, nullptr);
    TDD_setPtr(__TDD_var_0, 6, 0);
    TDD_registerFree(archive_read_free, __TDD_var_0);
    goto ROOT;
}
...
NODEID_3 : {
    ...
    try { __TDD_var_1 = archive_read_support_filter_all(__TDD_var_0); } catch (...) {goto RETURN;}
...
NODEID_4 : {
    ...
    void *__TDD_var_0 = TDD_getPtr(6);
    uint32_t __TDD_var_1;
    try { __TDD_var_1 = archive_read_support_format_all(__TDD_var_0); } catch (...) {goto RETURN;}
    TDD_EQ(__TDD_var_1, 0);
    goto ROOT;
}
...
NODEID_5 : {
    ...
    uint64_t __TDD_var_2[1] = {10240};
    uint64_t __TDD_var_3 = __TDD_var_2[TDD_getInt() % 1];
    uint64_t __TDD_var_4 = forceUseValue ? __TDD_var_3 : TDD_getInt();
    uint32_t __TDD_var_5;
    try { __TDD_var_5 = archive_read_open_filename(__TDD_var_0, __TDD_var_1, __TDD_var_4); } catch (...) {goto RETURN;}
    TDD_registerFree(archive_read_close, __TDD_var_0);
    TDD_EQ(__TDD_var_5, 0);
    goto ROOT;
}
...
NODEID_6 : {
    ...
    try { __TDD_var_2 = archive_read_next_header(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
...
NODEID_7 : {
    ...
    void *__TDD_var_1;
    try { __TDD_var_1 = archive_entry_pathname(__TDD_var_0); } catch (...) {goto RETURN;}
...
NODEID_8 : {
    ...
    uint32_t __TDD_var_2;
    try { __TDD_var_2 = archive_match_excluded(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
    TDD_EQ(__TDD_var_2, 0);
    goto ROOT;
}
...
NODEID_9 : {
    ...
    void *__TDD_var_0 = TDD_getPtr(6);
    void *__TDD_var_1 = TDD_getPtr(4);
    void *__TDD_var_2 = TDD_getPtr(3);
    uint32_t __TDD_var_3;
    try { __TDD_var_3 = archive_read_extract2(__TDD_var_0, __TDD_var_1, __TDD_var_2); } catch (...) {goto RETURN;}
...
NODEID_12 : {
    ...
    uint32_t __TDD_var_2;
    try { __TDD_var_2 = archive_match_path_unmatched_inclusions_next(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
    TDD_EQ(__TDD_var_2, 0);
    goto ROOT;
}
...
NODEID_13 : {
    ...
    void *__TDD_var_0 = TDD_getPtr(5);
    uint32_t __TDD_var_1;
    try { __TDD_var_1 = archive_match_path_unmatched_inclusions(__TDD_var_0); } catch (...) {goto RETURN;}
    TDD_EQ(__TDD_var_1, 0);
    goto ROOT;
}
