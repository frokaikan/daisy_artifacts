...
function ==> gsm_create
demangle ==> gsm_create
source ==> /home/frokaikan/Desktop/workspace/aosp/libgsm/src/gsm_create.c : 34
; Function Attrs: noinline nounwind optnone sanitize_address uwtable
hint !TDDDbg !0 ptr @gsm_create() #9
*****************/
void *gsm_create();
...
function ==> gsm_option
demangle ==> gsm_option
source ==> /home/frokaikan/Desktop/workspace/aosp/libgsm/src/gsm_option.c : 14
; Function Attrs: noinline nounwind optnone sanitize_address uwtable
hint !TDDDbg !0 i32 @gsm_option(ptr noundef, i32 noundef, ptr noundef) #9
*****************/
uint32_t gsm_option(void *, uint32_t, void *);

/****************
function ==> gsm_decode
demangle ==> gsm_decode
source ==> /home/frokaikan/Desktop/workspace/aosp/libgsm/src/gsm_decode.c : 14
; Function Attrs: noinline nounwind optnone sanitize_address uwtable
hint !TDDDbg !0 i32 @gsm_decode(ptr noundef, ptr noundef, ptr noundef) #9
*****************/
uint32_t gsm_decode(void *, void *, void *);

/****************
function ==> ulaw_output
demangle ==> ulaw_output
source ==> /home/frokaikan/Desktop/workspace/aosp/libgsm/src/toast_ulaw.c : 613
; Function Attrs: noinline nounwind optnone sanitize_address uwtable
hint !TDDDbg !0 i32 @ulaw_output(ptr noundef) #9
*****************/
uint32_t ulaw_output(void *);

/****************
function ==> gsm_destroy
demangle ==> gsm_destroy
source ==> /home/frokaikan/Desktop/workspace/aosp/libgsm/src/gsm_destroy.c : 23
; Function Attrs: noinline nounwind optnone sanitize_address uwtable
hint !TDDDbg !0 void @gsm_destroy(ptr noundef) #9
*****************/
...
NODEID_0 : {
    ...
    void *__TDD_var_0;
    try { __TDD_var_0 = gsm_create(); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_0, nullptr);
    TDD_registerFree(gsm_destroy, __TDD_var_0);
    TDD_setPtr(__TDD_var_0, 2, 0);
    goto ROOT;
}
...
NODEID_1 : {
    ...
    uint32_t __TDD_var_1[2] = {1, 2};
    uint32_t __TDD_var_2 = __TDD_var_1[TDD_getInt() % 2];
    uint32_t __TDD_var_3 = forceUseValue ? __TDD_var_2 : TDD_getInt();
    void *__TDD_var_4 = TDD_alloc(UNEG1);
    uint32_t __TDD_var_5;
    try { __TDD_var_5 = gsm_option(__TDD_var_0, __TDD_var_3, __TDD_var_4); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_2 : {
    ...
    try { __TDD_var_3 = gsm_decode(__TDD_var_0, __TDD_var_1, __TDD_var_2); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_3 : {
    ...
    // try { __TDD_var_1 = ulaw_output(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_4 : {
    if (!TDD_runNode()) goto ROOT;
    // void *__TDD_var_0 = TDD_getPtr(2);
    // try { gsm_destroy(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
