...
demangle ==> sqlite3_open_v2
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/sqlite-2016-11-14/sqlite3.c : 141039
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @sqlite3_open_v2(ptr noundef, ptr noundef, i32 noundef, ptr noundef) #0
*****************/
uint32_t sqlite3_open_v2(void *, void *, uint32_t, void *);

/****************
function ==> sqlite3_progress_handler
demangle ==> sqlite3_progress_handler
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/sqlite-2016-11-14/sqlite3.c : 139453
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @sqlite3_progress_handler(ptr noundef, i32 noundef, ptr noundef, ptr noundef) #0
*****************/
void sqlite3_progress_handler(void *, uint32_t, void *, void *);

/****************
function ==> sqlite3_db_config
demangle ==> sqlite3_db_config
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/sqlite-2016-11-14/sqlite3.c : 138718
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @sqlite3_db_config(ptr noundef, i32 noundef, ...) #0
*****************/
uint32_t sqlite3_db_config(void *, uint32_t, ...);

/****************
function ==> sqlite3_mprintf
demangle ==> sqlite3_mprintf
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/sqlite-2016-11-14/sqlite3.c : 25716
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @sqlite3_mprintf(ptr noundef, ...) #0
*****************/
void *sqlite3_mprintf(void *, ...);

/****************
function ==> sqlite3_exec
demangle ==> sqlite3_exec
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/sqlite-2016-11-14/sqlite3.c : 109682
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @sqlite3_exec(ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef) #0
*****************/
uint32_t sqlite3_exec(void *, void *, void *, void *, void *);

/****************
function ==> sqlite3_free
demangle ==> sqlite3_free
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/sqlite-2016-11-14/sqlite3.c : 24350
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @sqlite3_free(ptr noundef) #0
*****************/
void sqlite3_free(void *);

/****************
function ==> sqlite3_close
demangle ==> sqlite3_close
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/sqlite-2016-11-14/sqlite3.c : 139022
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @sqlite3_close(ptr noundef) #0
*****************/
uint32_t sqlite3_close(void *);
...
LOADMEM:
{
    TDD_setLoadPtr(3, 0, 5, 8);
}

{
    TDD_setLoadPtr(2, 0, 6, 8);
}
...
NODEID_1 : {
    ...
    void *__TDD_var_1 = TDD_getPtr(3);
    uint32_t __TDD_var_2[1] = {134};
    ...
    try { __TDD_var_6 = sqlite3_open_v2(__TDD_var_0, __TDD_var_1, __TDD_var_4, __TDD_var_5); } catch (...) {goto RETURN;}
...
NODEID_2 : {
    ...
    void *__TDD_var_1 = TDD_addPtr(__TDD_var_0, 8);
    uint32_t __TDD_var_2[1] = {4};
    uint32_t __TDD_var_3 = __TDD_var_2[TDD_getInt() % 1];
    uint32_t __TDD_var_4 = forceUseValue ? __TDD_var_3 : TDD_getInt();
    void *__TDD_var_5 = nullptr;
    void *__TDD_var_6 = TDD_getPtr(0);
    try { sqlite3_progress_handler(__TDD_var_1, __TDD_var_4, __TDD_var_5, __TDD_var_6); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_3 : {
    ...
    try { __TDD_var_9 = sqlite3_db_config(__TDD_var_1, __TDD_var_4, __TDD_var_7, __TDD_var_8); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_5 : {
    ...
    void *__TDD_var_0 = TDD_getPtr(5);
    void *__TDD_var_1 = TDD_addPtr(__TDD_var_0, 8);
    void *__TDD_var_3 = TDD_alloc(UNEG1);
    void *__TDD_var_4 = nullptr;
    void *__TDD_var_5 = TDD_getPtr(1);
    void *__TDD_var_6 = TDD_getPtr(2);
    uint32_t __TDD_var_7;
    try { __TDD_var_7 = sqlite3_exec(__TDD_var_1, __TDD_var_3, __TDD_var_4, __TDD_var_5, __TDD_var_6); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_6 : {
    ...
    void *__TDD_var_1 = TDD_addPtr(__TDD_var_0, 8);
    try { sqlite3_free(__TDD_var_1); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_8 : {
    ...
    try { __TDD_var_2 = sqlite3_close(__TDD_var_1); } catch (...) {goto RETURN;}
    goto ROOT;
}
