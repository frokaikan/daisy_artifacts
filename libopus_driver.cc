...
demangle ==> opus_get_version_string
source ==> /home/frokaikan/Desktop/workspace/aosp/libopus/celt/celt.c : 303
; Function Attrs: noinline nounwind sanitize_address sspstrong uwtable
hint !TDDDbg !0 ptr @opus_get_version_string() #9
*****************/
void *opus_get_version_string();

/****************
function ==> opus_decoder_create
demangle ==> opus_decoder_create
source ==> /home/frokaikan/Desktop/workspace/aosp/libopus/src/opus_decoder.c : 159
; Function Attrs: noinline nounwind sanitize_address sspstrong uwtable
hint !TDDDbg !0 ptr @opus_decoder_create(i32 noundef, i32 noundef, ptr noundef) #9
*****************/
void *opus_decoder_create(uint32_t, uint32_t, void *);

/****************
function ==> opus_decode
demangle ==> opus_decode
source ==> /home/frokaikan/Desktop/workspace/aosp/libopus/src/opus_decoder.c : 751
; Function Attrs: noinline nounwind sanitize_address sspstrong uwtable
hint !TDDDbg !0 i32 @opus_decode(ptr noundef, ptr noundef, i32 noundef, ptr noundef, i32 noundef, i32 noundef) #9
*****************/
uint32_t opus_decode(void *, void *, uint32_t, void *, uint32_t, uint32_t);

/****************
function ==> opus_decoder_ctl
demangle ==> opus_decoder_ctl
source ==> /home/frokaikan/Desktop/workspace/aosp/libopus/src/opus_decoder.c : 842
; Function Attrs: noinline nounwind sanitize_address sspstrong uwtable
hint !TDDDbg !0 i32 @opus_decoder_ctl(ptr noundef, i32 noundef, ...) #9
*****************/
uint32_t opus_decoder_ctl(void *, uint32_t, ...);

/****************
function ==> opus_encoder_destroy
demangle ==> opus_encoder_destroy
source ==> /home/frokaikan/Desktop/workspace/aosp/libopus/src/opus_encoder.c : 2777
; Function Attrs: noinline nounwind sanitize_address sspstrong uwtable
hint !TDDDbg !0 void @opus_encoder_destroy(ptr noundef) #9
*****************/
void opus_encoder_destroy(void *);

/****************
function ==> opus_decoder_destroy
demangle ==> opus_decoder_destroy
source ==> /home/frokaikan/Desktop/workspace/aosp/libopus/src/opus_decoder.c : 975
; Function Attrs: noinline nounwind sanitize_address sspstrong uwtable
hint !TDDDbg !0 void @opus_decoder_destroy(ptr noundef) #9
*****************/
void opus_decoder_destroy(void *);
...
{
    uint64_t __TDD_var_0 = 384000;
    void *__TDD_var_1 = TDD_alloc(__TDD_var_0);
    TDD_setPtr(__TDD_var_1, 2, 0);
}

{
    uint64_t __TDD_var_0 = 1500;
    void *__TDD_var_1 = TDD_alloc(__TDD_var_0);
...
NODEID_0 : {
    ...
    void *__TDD_var_0;
    try { __TDD_var_0 = opus_get_version_string(); } catch (...) {goto RETURN;}
...
NODEID_1 : {
    ...
    void *__TDD_var_7;
    try { __TDD_var_7 = opus_decoder_create(__TDD_var_2, __TDD_var_5, __TDD_var_6); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_7, nullptr);
    TDD_registerFree(opus_decoder_destroy, __TDD_var_7);
    TDD_setPtr(__TDD_var_7, 4, 0);
    goto ROOT;
}
...
NODEID_3 : {
    ...
    void *__TDD_var_5 = TDD_getPtr(2);
    uint32_t __TDD_var_6[1] = {96000};
    ...
    try { __TDD_var_12 = opus_decode(__TDD_var_0, __TDD_var_1, __TDD_var_4, __TDD_var_5, __TDD_var_8, __TDD_var_11); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_4 : {
    ...
    if (!TDD_runNode()) goto ROOT;
    void *__TDD_var_0 = TDD_getPtr(4);
    uint32_t __TDD_var_1[1] = {4031};
    uint32_t __TDD_var_2 = __TDD_var_1[TDD_getInt() % 1];
    uint32_t __TDD_var_3 = forceUseValue ? __TDD_var_2 : TDD_getInt();
    void *__TDD_var_4 = TDD_getPtr(1);
    uint32_t __TDD_var_5;
    try { __TDD_var_5 = opus_decoder_ctl(__TDD_var_0, __TDD_var_3, __TDD_var_4); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_5 : {
    ...
    // try { opus_encoder_destroy(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_6 : {
    ...
    if (!TDD_runNode()) goto ROOT;
    // void *__TDD_var_0 = TDD_getPtr(4);
    // try { opus_decoder_destroy(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
