...
demangle ==> xmlCheckVersion
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/parserInternals.c : 61
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @xmlCheckVersion(i32 noundef) #0
*****************/
void xmlCheckVersion(uint32_t);

/****************
function ==> xmlSAXDefaultVersion
demangle ==> xmlSAXDefaultVersion
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/SAX2.c : 2840
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @xmlSAXDefaultVersion(i32 noundef) #0
*****************/
uint32_t xmlSAXDefaultVersion(uint32_t);

/****************
function ==> xmlGetExternalEntityLoader
demangle ==> xmlGetExternalEntityLoader
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/xmlIO.c : 4042
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @xmlGetExternalEntityLoader() #0
*****************/
void *xmlGetExternalEntityLoader();

/****************
function ==> xmlSetExternalEntityLoader
demangle ==> xmlSetExternalEntityLoader
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/xmlIO.c : 4030
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @xmlSetExternalEntityLoader(ptr noundef) #0
*****************/
void xmlSetExternalEntityLoader(void *);

/****************
function ==> xmlLineNumbersDefault
demangle ==> xmlLineNumbersDefault
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/parserInternals.c : 1956
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @xmlLineNumbersDefault(i32 noundef) #0
*****************/
uint32_t xmlLineNumbersDefault(uint32_t);

/****************
function ==> xmlReadFile
demangle ==> xmlReadFile
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/parser.c : 15218
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @xmlReadFile(ptr noundef, ptr noundef, i32 noundef) #0
*****************/
void *xmlReadFile(void *, void *, uint32_t);

/****************
function ==> xmlSaveToFd
demangle ==> xmlSaveToFd
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/xmlsave.c : 1764
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @xmlSaveToFd(i32 noundef, ptr noundef, i32 noundef) #0
*****************/
void *xmlSaveToFd(uint32_t, void *, uint32_t);

/****************
function ==> xmlSaveDoc
demangle ==> xmlSaveDoc
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/xmlsave.c : 1880
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i64 @xmlSaveDoc(ptr noundef, ptr noundef) #0
*****************/
uint64_t xmlSaveDoc(void *, void *);

/****************
function ==> xmlSaveClose
demangle ==> xmlSaveClose
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/xmlsave.c : 1951
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @xmlSaveClose(ptr noundef) #0
*****************/
uint32_t xmlSaveClose(void *);

/****************
function ==> xmlFreeDoc
demangle ==> xmlFreeDoc
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/tree.c : 1206
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @xmlFreeDoc(ptr noundef) #0
*****************/
void xmlFreeDoc(void *);

/****************
function ==> xmlCleanupParser
demangle ==> xmlCleanupParser
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/parser.c : 14730
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @xmlCleanupParser() #0
*****************/
void xmlCleanupParser();

/****************
function ==> xmlMemoryDump
demangle ==> xmlMemoryDump
source ==> /home/frokaikan/Desktop/workspace/aosp/libxml2/xmlmemory.c : 910
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @xmlMemoryDump() #0
*****************/
void xmlMemoryDump();
...
OTHER:
    TDD_registerFree([] (void *) -> void {xmlCleanupParser();}, nullptr);
    TDD_registerFree([] (void *) -> void {xmlMemoryDump();}, nullptr);
...
NODEID_0 : {
    ...
    uint32_t __TDD_var_0[1] = {20913};
    uint32_t __TDD_var_1 = __TDD_var_0[TDD_getInt() % 1];
    uint32_t __TDD_var_2 = __TDD_var_1;
    try { xmlCheckVersion(__TDD_var_2); } catch (...) {goto RETURN;}
    goto ROOT;
}

NODEID_1 : {
    if (!TDD_runNode()) goto ROOT;
    uint32_t __TDD_var_0[1] = {2};
    uint32_t __TDD_var_1 = __TDD_var_0[TDD_getInt() % 1];
    uint32_t __TDD_var_2 = __TDD_var_1;
    uint32_t __TDD_var_3;
    try { __TDD_var_3 = xmlSAXDefaultVersion(__TDD_var_2); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_2 : {
    if (!TDD_runNode()) goto ROOT;
    void *__TDD_var_0;
    try { __TDD_var_0 = xmlGetExternalEntityLoader(); } catch (...) {goto RETURN;}
...
NODEID_3 : {
    ...
    // try { xmlSetExternalEntityLoader(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}

NODEID_4 : {
    if (!TDD_runNode()) goto ROOT;
    uint32_t __TDD_var_0[1] = {1};
    uint32_t __TDD_var_1 = __TDD_var_0[TDD_getInt() % 1];
    uint32_t __TDD_var_2 = forceUseValue ? __TDD_var_1 : TDD_getInt();
    uint32_t __TDD_var_3;
    try { __TDD_var_3 = xmlLineNumbersDefault(__TDD_var_2); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_5 : {
    ...
    uint32_t __TDD_var_2[1] = {4259840};
    uint32_t __TDD_var_3 = __TDD_var_2[TDD_getInt() % 1];
    uint32_t __TDD_var_4 = forceUseValue ? __TDD_var_3 : TDD_getInt();
    void *__TDD_var_5;
    try { __TDD_var_5 = xmlReadFile(__TDD_var_0, __TDD_var_1, __TDD_var_4); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_5, nullptr);
    TDD_setPtr(__TDD_var_5, 0, 0);
    goto ROOT;
}
...
NODEID_6 : {
    ...
    void *__TDD_var_7;
    try { __TDD_var_7 = xmlSaveToFd(__TDD_var_2, __TDD_var_3, __TDD_var_6); } catch (...) {goto RETURN;}
    TDD_registerFree(xmlSaveClose, __TDD_var_7);
    TDD_NE(__TDD_var_7, nullptr);
    TDD_setPtr(__TDD_var_7, 1, 0);
    goto ROOT;
}
...
NODEID_7 : {
    ...
    uint64_t __TDD_var_2;
    try { __TDD_var_2 = xmlSaveDoc(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
    TDD_registerFree(xmlFreeDoc, __TDD_var_1);
    goto ROOT;
}
...
NODEID_8 : {
    ...
    // try { __TDD_var_1 = xmlSaveClose(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_9 : {
    ...
    // try { xmlFreeDoc(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}

NODEID_10 : {
    if (!TDD_runNode()) goto ROOT;
    // try { xmlCleanupParser(); } catch (...) {goto RETURN;}
    goto ROOT;
}

NODEID_11 : {
    if (!TDD_runNode()) goto ROOT;
    // try { xmlMemoryDump(); } catch (...) {goto RETURN;}
    goto ROOT;
}
