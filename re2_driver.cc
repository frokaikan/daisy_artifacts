...
/****************
function ==> _ZN3re211StringPieceC2EPKc
demangle ==> re2::StringPiece::StringPiece(char const*)
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/re2-2014-12-09/build/SRC/re2/stringpiece.h : 39
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @_ZN3re211StringPieceC2EPKc(ptr noundef nonnull align 8 dereferenceable(12), ptr noundef) #3
*****************/
void _ZN3re211StringPieceC2EPKc(void *, void *);

/****************
function ==> _ZN3re23RE2C1EPKc
demangle ==> re2::RE2::RE2(char const*)
source ==> 
; Function Attrs: sanitize_address
hint void @_ZN3re23RE2C1EPKc(ptr noundef nonnull align 8 dereferenceable(216), ptr noundef) #4
*****************/
void _ZN3re23RE2C1EPKc(void *, void *);

/****************
function ==> _ZNK3re217VariadicFunction2IbRKNS_11StringPieceERKNS_3RE2ENS4_3ArgEXadL_ZNS4_10FullMatchNES3_S6_PKPKS7_iEEEclES3_S6_
demangle ==> re2::VariadicFunction2<bool, re2::StringPiece const&, re2::RE2 const&, re2::RE2::Arg, &re2::RE2::FullMatchN(re2::StringPiece const&, re2::RE2 const&, re2::RE2::Arg const* const*, int)>::operator()(re2::StringPiece const&, re2::RE2 const&) const
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/re2-2014-12-09/build/SRC/re2/variadic_function.h : 14
; Function Attrs: mustprogress noinline sanitize_address uwtable
hint !TDDDbg !0 noundef zeroext i1 @_ZNK3re217VariadicFunction2IbRKNS_11StringPieceERKNS_3RE2ENS4_3ArgEXadL_ZNS4_10FullMatchNES3_S6_PKPKS7_iEEEclES3_S6_(ptr noundef nonnull align 1 dereferenceable(1), ptr noundef nonnull align 8 dereferenceable(12), ptr noundef nonnull align 8 dereferenceable(216)) #5
*****************/
bool _ZNK3re217VariadicFunction2IbRKNS_11StringPieceERKNS_3RE2ENS4_3ArgEXadL_ZNS4_10FullMatchNES3_S6_PKPKS7_iEEEclES3_S6_(void *, void *, void *);

/****************
function ==> _ZN3re23RE2D1Ev
demangle ==> re2::RE2::~RE2()
source ==> 
; Function Attrs: nounwind sanitize_address
hint void @_ZN3re23RE2D1Ev(ptr noundef nonnull align 8 dereferenceable(216)) #6
*****************/
void _ZN3re23RE2D1Ev(void *);
...
NODEID_0 : {
    ...
    try { _ZN3re211StringPieceC2EPKc(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_1 : {
    ...
    void *__TDD_var_1 = TDD_alloc(UNEG1);
    try { _ZN3re23RE2C1EPKc(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_2 : {
    ...
    bool __TDD_var_3;
    try { __TDD_var_3 = _ZNK3re217VariadicFunction2IbRKNS_11StringPieceERKNS_3RE2ENS4_3ArgEXadL_ZNS4_10FullMatchNES3_S6_PKPKS7_iEEEclES3_S6_(__TDD_var_0, __TDD_var_1, __TDD_var_2); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_3 : {
    ...
    if (!TDD_runNode()) goto ROOT;
    void *__TDD_var_0 = TDD_getPtr(1);
    try { _ZN3re23RE2D1Ev(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
