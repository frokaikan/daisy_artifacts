...
function ==> pj_init
demangle ==> pj_init
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/proj4-2017-08-14/build/SRC/src/pj_init.c : 427
; Function Attrs: nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @pj_init(i32 noundef, ptr nocapture noundef readonly) #0
*****************/
void *pj_init(uint32_t, void *);

/****************
function ==> pj_is_latlong
demangle ==> pj_is_latlong
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/proj4-2017-08-14/build/SRC/src/pj_utils.c : 42
; Function Attrs: argmemonly mustprogress nofree norecurse nosync nounwind readonly sanitize_address willreturn uwtable
hint !TDDDbg !0 i32 @pj_is_latlong(ptr noundef readonly) #29
*****************/
uint32_t pj_is_latlong(void *);

/****************
function ==> dmstor
demangle ==> dmstor
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/proj4-2017-08-14/build/SRC/src/dmstor.c : 19
; Function Attrs: nounwind sanitize_address uwtable
hint !TDDDbg !0 double @dmstor(ptr noundef, ptr noundef) #0
*****************/
double dmstor(void *, void *);

/****************
function ==> pj_fwd
demangle ==> pj_fwd
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/proj4-2017-08-14/build/SRC/src/pj_fwd.c : 7
; Function Attrs: nounwind sanitize_address uwtable
hint !TDDDbg !0 { double, double } @pj_fwd(double, double, ptr noundef) #0
*****************/
__TDD_DB_DB pj_fwd(double, double, void *);

/****************
function ==> pj_free
demangle ==> pj_free
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/proj4-2017-08-14/build/SRC/src/pj_init.c : 777
; Function Attrs: nounwind sanitize_address uwtable
hint !TDDDbg !0 void @pj_free(ptr noundef) #0
*****************/
void pj_free(void *);

/****************
function ==> pj_transform
demangle ==> pj_transform
source ==> /home/frokaikan/Desktop/workspace/fuzzer-test-suite-Sep/proj4-2017-08-14/build/SRC/src/pj_transform.c : 83
; Function Attrs: nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @pj_transform(ptr noundef, ptr noundef, i64 noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef) #0
*****************/
uint32_t pj_transform(void *, void *, uint64_t, uint32_t, void *, void *, void *);
...
GRAPH:
    ...
    TDD_addEdge(24, 25);
    TDD_addEdge(25, 26);
    TDD_addEdge(26, UNEG1);
    TDD_addEdge(UNEG1, 0);
    TDD_addEdge(UNEG1, 13);
...
ROOT:
    ...
    switch (toID) {
        ...
        case 22 : goto NODEID_22;
        case 23 : goto NODEID_23;
        case 24 : goto NODEID_24;
        case 25 : goto NODEID_25;
        case 26 : goto NODEID_26;
...
NODEID_3 : {
    ...
    void *__TDD_var_3 = TDD_getArg(__TDD_var_2);
    void *__TDD_var_4;
    try { __TDD_var_4 = pj_init(__TDD_var_2, __TDD_var_3); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_4, nullptr);
    TDD_setPtr(__TDD_var_4, 3, 0);
    TDD_registerFree(pj_free, __TDD_var_4);
    goto ROOT;
}
...
NODEID_4 : {
    ...
    try { __TDD_var_1 = pj_is_latlong(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_7 : {
    ...
    void *__TDD_var_1 = TDD_getPtr(1);
    double __TDD_var_2;
    try { __TDD_var_2 = dmstor(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_8 : {
    ...
    if (!TDD_runNode()) goto ROOT;
    void *__TDD_var_0 = TDD_getPtr(0);
    void *__TDD_var_1 = TDD_addPtr(__TDD_var_0, 1);
    void *__TDD_var_2 = TDD_getPtr(1);
    double __TDD_var_3;
    try { __TDD_var_3 = dmstor(__TDD_var_1, __TDD_var_2); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_9 : {
    ...
    void *__TDD_var_1 = TDD_addPtr(__TDD_var_0, 1);
    void *__TDD_var_2 = TDD_getPtr(1);
    *static_cast<void **>(__TDD_var_2) = __TDD_var_1;
    goto ROOT;
}
...
NODEID_10 : {
    if (!TDD_checkMemDep(3)) goto ROOT;
    if (!TDD_runNode()) goto ROOT;
    double __TDD_var_0[1] = {0.0174533};
    double __TDD_var_1 = __TDD_var_0[TDD_getInt() % 1];
    double __TDD_var_2 = forceUseValue ? __TDD_var_1 : TDD_getDouble();
    double __TDD_var_3[1] = {0};
    double __TDD_var_4 = __TDD_var_3[TDD_getInt() % 1];
    double __TDD_var_5 = forceUseValue ? __TDD_var_4 : TDD_getDouble();
    void *__TDD_var_6 = TDD_getPtr(3);
    __TDD_DB_DB __TDD_var_7;
    try { __TDD_var_7 = pj_fwd(__TDD_var_2, __TDD_var_5, __TDD_var_6); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_22 : {
    ...
    if (!TDD_checkMemDep(9)) goto ROOT;
    if (!TDD_checkMemDep(4)) goto ROOT;
    if (!TDD_checkMemDep(4)) goto ROOT;
    if (!TDD_checkMemDep(5)) goto ROOT;
    if (!TDD_runNode()) goto ROOT;
    void *__TDD_var_0 = TDD_getPtr(8);
    void *__TDD_var_1 = TDD_getPtr(9);
    uint64_t __TDD_var_2[1] = {1};
    ...
    void *__TDD_var_8 = TDD_getPtr(4);
    void *__TDD_var_9 = TDD_getPtr(4);
    void *__TDD_var_10 = TDD_addPtr(__TDD_var_9, 8);
    void *__TDD_var_11 = TDD_getPtr(5);
    uint32_t __TDD_var_12;
    try { __TDD_var_12 = pj_transform(__TDD_var_0, __TDD_var_1, __TDD_var_4, __TDD_var_7, __TDD_var_8, __TDD_var_10, __TDD_var_11); } catch (...) {goto RETURN;}
    goto ROOT;
}
