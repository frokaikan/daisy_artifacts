...
/****************
function ==> aom_video_reader_open
demangle ==> aom_video_reader_open
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/common/video_reader.c : 33
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @aom_video_reader_open(ptr noundef) #0
*****************/
void *aom_video_reader_open(void *);

/****************
function ==> aom_video_reader_get_info
demangle ==> aom_video_reader_get_info
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/common/video_reader.c : 121
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @aom_video_reader_get_info(ptr noundef) #0
*****************/
void *aom_video_reader_get_info(void *);

/****************
function ==> get_aom_decoder_by_fourcc
demangle ==> get_aom_decoder_by_fourcc
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/common/tools_common.c : 207
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @get_aom_decoder_by_fourcc(i32 noundef) #0
*****************/
void *get_aom_decoder_by_fourcc(uint32_t);

/****************
function ==> aom_codec_iface_name
demangle ==> aom_codec_iface_name
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/aom/src/aom_codec.c : 31
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @aom_codec_iface_name(ptr noundef) #0
*****************/
void *aom_codec_iface_name(void *);

/****************
function ==> aom_codec_dec_init_ver
demangle ==> aom_codec_dec_init_ver
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/aom/src/aom_decoder.c : 25
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @aom_codec_dec_init_ver(ptr noundef, ptr noundef, ptr noundef, i64 noundef, i32 noundef) #0
*****************/
uint32_t aom_codec_dec_init_ver(void *, void *, void *, uint64_t, uint32_t);

/****************
function ==> aom_video_reader_read_frame
demangle ==> aom_video_reader_read_frame
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/common/video_reader.c : 86
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @aom_video_reader_read_frame(ptr noundef) #0
*****************/
uint32_t aom_video_reader_read_frame(void *);

/****************
function ==> aom_video_reader_get_frame
demangle ==> aom_video_reader_get_frame
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/common/video_reader.c : 106
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @aom_video_reader_get_frame(ptr noundef, ptr noundef) #0
*****************/
void *aom_video_reader_get_frame(void *, void *);

/****************
function ==> aom_codec_decode
demangle ==> aom_codec_decode
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/aom/src/aom_decoder.c : 94
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @aom_codec_decode(ptr noundef, ptr noundef, i64 noundef, ptr noundef) #0
*****************/
uint32_t aom_codec_decode(void *, void *, uint64_t, void *);

/****************
function ==> aom_codec_get_frame
demangle ==> aom_codec_get_frame
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/aom/src/aom_decoder.c : 109
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 ptr @aom_codec_get_frame(ptr noundef, ptr noundef) #0
*****************/
void *aom_codec_get_frame(void *, void *);

/****************
function ==> aom_img_write
demangle ==> aom_img_write
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/common/tools_common.c : 237
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @aom_img_write(ptr noundef, ptr noundef) #0
*****************/
void aom_img_write(void *, void *);

/****************
function ==> aom_codec_destroy
demangle ==> aom_codec_destroy
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/aom/src/aom_codec.c : 67
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 i32 @aom_codec_destroy(ptr noundef) #0
*****************/
uint32_t aom_codec_destroy(void *);

/****************
function ==> aom_video_reader_close
demangle ==> aom_video_reader_close
source ==> /home/frokaikan/Desktop/workspace/aosp/libaom/libaom/common/video_reader.c : 75
; Function Attrs: noinline nounwind sanitize_address uwtable
hint !TDDDbg !0 void @aom_video_reader_close(ptr noundef) #0
*****************/
void aom_video_reader_close(void *);
...
NODEID_0 : {
    ...
    void *__TDD_var_1;
    try { __TDD_var_1 = aom_video_reader_open(__TDD_var_0); } catch (...) {goto RETURN;}
    // TDD_NE(__TDD_var_1, nullptr);
    TDD_registerFree(aom_video_reader_close, __TDD_var_1);
    TDD_NE(__TDD_var_1, nullptr);
...
NODEID_1 : {
    ...
    void *__TDD_var_1;
    try { __TDD_var_1 = aom_video_reader_get_info(__TDD_var_0); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_1, nullptr);
    goto ROOT;
}
...
NODEID_2 : {
    if (!TDD_runNode()) goto ROOT;
    uint32_t __TDD_var_0[1] = {825251393};
    uint32_t __TDD_var_1 = __TDD_var_0[TDD_getInt() % 1];
    uint32_t __TDD_var_2 = __TDD_var_1;
    void *__TDD_var_3;
    try { __TDD_var_3 = get_aom_decoder_by_fourcc(__TDD_var_2); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_3, nullptr);
    TDD_setPtr(__TDD_var_3, 6, 0);
    goto ROOT;
}
...
NODEID_3 : {
    ...
    void *__TDD_var_1;
    try { __TDD_var_1 = aom_codec_iface_name(__TDD_var_0); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_1, nullptr);
    goto ROOT;
}
...
NODEID_4 : {
    ...
    uint32_t __TDD_var_6[1] = {22};
    uint32_t __TDD_var_7 = __TDD_var_6[TDD_getInt() % 1];
    uint32_t __TDD_var_8 = forceUseValue ? __TDD_var_7 : TDD_getInt();
    uint32_t __TDD_var_9;
    try { __TDD_var_9 = aom_codec_dec_init_ver(__TDD_var_0, __TDD_var_1, __TDD_var_2, __TDD_var_5, __TDD_var_8); } catch (...) {goto RETURN;}
    TDD_EQ(__TDD_var_9, 0);
    TDD_registerFree(aom_codec_destroy, __TDD_var_0);
    goto ROOT;
}
...
NODEID_5 : {
    ...
    try { __TDD_var_1 = aom_video_reader_read_frame(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_7 : {
    ...
    void *__TDD_var_2;
    try { __TDD_var_2 = aom_video_reader_get_frame(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
...
NODEID_8 : {
    ...
    uint64_t __TDD_var_2[2] = {29, 34};
    uint64_t __TDD_var_3 = __TDD_var_2[TDD_getInt() % 2];
    uint64_t __TDD_var_4 = forceUseValue ? __TDD_var_3 : TDD_getInt();
    void *__TDD_var_5 = nullptr;
    uint32_t __TDD_var_6;
    try { __TDD_var_6 = aom_codec_decode(__TDD_var_0, __TDD_var_1, __TDD_var_4, __TDD_var_5); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_9 : {
    ...
    void *__TDD_var_1 = TDD_getPtr(1);
    void *__TDD_var_2;
    try { __TDD_var_2 = aom_codec_get_frame(__TDD_var_0, __TDD_var_1); } catch (...) {goto RETURN;}
    TDD_NE(__TDD_var_2, nullptr);
    TDD_setPtr(__TDD_var_2, 5, 264);
    goto ROOT;
}
...
NODEID_10 : {
    ...
    void *__TDD_var_1 = TDD_addPtr(__TDD_var_0, 264);
    void *__TDD_var_2 = TDD_getFile(0);
    try { aom_img_write(__TDD_var_1, __TDD_var_2); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_12 : {
    ...
    // void *__TDD_var_0 = TDD_getPtr(0);
    // uint32_t __TDD_var_1;
    // try { __TDD_var_1 = aom_codec_destroy(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
...
NODEID_13 : {
    ...
    if (!TDD_runNode()) goto ROOT;
    // void *__TDD_var_0 = TDD_getPtr(3);
    // try { aom_video_reader_close(__TDD_var_0); } catch (...) {goto RETURN;}
    goto ROOT;
}
